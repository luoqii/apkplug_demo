...
public class Launcher extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ApkplugAdsPlugAgent.getInstance(null).InitAdsPlug(this);
		ApkplugAdsPlugAgent.getInstance(null).setAdsDownloadWifi(true);
		ApkplugAdsPlugAgent.getInstance(null).setAdsShowAuto(AdsCloudAgent.top_bottom_activity_auto_show);
    }
